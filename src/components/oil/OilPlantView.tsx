...
export function OilPlantView() {
  ...
  const sel = (id: SelKey) => (e: React.MouseEvent) => {
    e.stopPropagation();
    ...
    >
      ...
      >
        ...
        <Pipe
          ...
          color={GAS}
          dashed
          thick={Math.max(6, Math.min(14, s.sepGasFlow / 80))}
        />
        ...
        <SensorBadge
          ...
          type="PT"
          id="PT-201"
          value={`${s.wellPressure.toFixed(0)} bar`}
          onClick={sel("PT-201")}
        />
        <SensorBadge
          x={170}
        ...
        <g onClick={sel("sep")} className="cursor-pointer">
          ...
          <path
            d="M 360 340 A 28 60 0 0 0 360 460 L 380 460 L 380 340 Z"
            fill="url(#oVessel)"
            stroke="#3a4258"
            strokeWidth="1.5"
          />
          ...
          <path
            d="M 720 340 A 28 60 0 0 1 720 460 L 700 460 L 700 340 Z"
            fill="url(#oVessel)"
            stroke="#3a4258"
            strokeWidth="1.5"
          />

          <clipPath id="sepClipV201">
            <rect x="381" y="341" width="338" height="118" />
          </clipPath>
          <g clipPath="url(#sepClipV201)">
            <rect
              x="380"
              y={460 - (s.waterLevel / 100) * 60}
              width="340"
              height={(s.waterLevel / 100) * 60 + 4}
              fill="url(#oWater)"
              opacity="0.9"
            />
            <rect
              x="380"
              y={460 - (s.waterLevel / 100) * 60 - (s.oilLevel / 100) * 50}
              width="340"
              height={(s.oilLevel / 100) * 50}
              fill="url(#oOil)"
              opacity="0.9"
            />
            <line
              x1="380"
              y1={460 - (s.waterLevel / 100) * 60}
              x2="720"
              y2={460 - (s.waterLevel / 100) * 60}
              stroke="#a5ddff"
              strokeWidth="2"
              opacity="0.8"
            />
            <line
              x1="380"
              y1={460 - (s.waterLevel / 100) * 60 - (s.oilLevel / 100) * 50}
              x2="720"
              y2={460 - (s.waterLevel / 100) * 60 - (s.oilLevel / 100) * 50}
              stroke="#ffd9a0"
              strokeWidth="2"
              opacity="0.8"
            />
          ...
          <text
            ...
            className="scada-value"
          >
            Oil {s.oilLevel.toFixed(0)}% · Water {s.waterLevel.toFixed(0)}% · BS&amp;W{" "}
            {s.bsw.toFixed(2)}% · {s.sepPressure.toFixed(1)} bar
          </text>
        </g>
        ...
        <SensorBadge
          ...
          type="PT"
          id="PT-202"
          value={`${s.sepPressure.toFixed(1)} bar`}
          onClick={sel("PT-202")}
        />
        <SensorBadge
          x={465}
        ...
        <g onClick={sel("pump")} className="cursor-pointer">
          ...
          <path
            d="M 999 318 L 999 290 L 1080 290 L 1080 395"
            stroke="#3a4258"
            strokeWidth="10"
            fill="none"
            strokeLinecap="round"
          ...
          <text
            ...
            className="scada-value"
          >
            η {s.pumpEff.toFixed(0)}% ΔP {s.pumpDP.toFixed(1)}
          </text>
          <text
            x="980"
            y="610"
        ...
        <SensorBadge
          ...
          type="PT"
          id="PT-203"
          value={`${(s.sepPressure * 0.9).toFixed(1)} bar`}
          onClick={sel("PT-203")}
        />
        <SensorBadge
          x={1080}
          ...
          type="FT"
          id="FT-201"
          value={`${s.pumpFlow.toFixed(0)} m³/h`}
          onClick={sel("FT-201")}
        />
        ...
        <g onClick={sel("hx")} className="cursor-pointer">
          ...
          <text x="1239" y="325" fill="#ff5577" fontSize="12" className="scada-value">
            UT IN
          </text>
          <text x="1401" y="485" fill="#ff5577" fontSize="12" className="scada-value">
            UT OUT
          </text>
          <text
            x="1320"
          ...
          <text
            ...
            className="scada-value"
          >
            {s.hxCrudeIn.toFixed(0)}→{s.hxCrudeOut.toFixed(0)}°C · Q {s.hxDuty.toFixed(0)} kW · LMTD{" "}
            {s.hxLMTD.toFixed(1)}°C
          </text>
        </g>
        <SensorBadge
          x={1175}
        ...
        <SensorBadge
          ...
          type="TT"
          id="TT-203"
          value={`${s.hxCrudeOut.toFixed(0)}°C`}
          onClick={sel("TT-203")}
        />
        <ControlValve
          x={1410}
        ...
        <g onClick={sel("dehy")} className="cursor-pointer">
          ...
          <line
            ...
            x2="1640"
            y2="355"
            stroke={s.dehydratorOn ? "#ffcc00" : "#444"}
            strokeWidth="3"
          />
          <line
            x1="1500"
          ...
          <text
            ...
            className="scada-value"
          >
            D-201 Electrostatic Dehydrator
          </text>
          <text
            x="1570"
            y="507"
        ...
        <g onClick={sel("tank")} className="cursor-pointer">
          <rect
            ...
            strokeWidth="1.5"
          />
          <clipPath id="tankClip201">
            <rect x="1701" y="221" width="238" height="358" />
          </clipPath>
          <g clipPath="url(#tankClip201)">
            <rect
              x="1700"
              y={580 - (s.tankLevel / 100) * 358}
              width="240"
              height={(s.tankLevel / 100) * 358 + 4}
              fill="url(#oOil)"
              opacity="0.85"
            />
            <rect
              x="1705"
              y={580 - (s.tankLevel / 100) * 358 - 8}
              width="230"
              height="12"
              fill="#3a4258"
              stroke="#1a2030"
          ...
          <rect
            x="1950"
            y={580 - (s.tankLevel / 100) * 340}
            width="12"
            height={(s.tankLevel / 100) * 340}
            fill="#ff8a4d"
          />
          <text
            x="1820"
        ...
        <g onClick={sel("wt")} className="cursor-pointer">
          ...
          <text
            ...
            className="scada-value"
          >
            WT-201 Water Treatment
          </text>
          <text
            x="560"
            y="812"
            textAnchor="middle"
            fill={s.wtOilInWater > 40 ? "#ff4444" : "#00ff88"}
            fontSize="13"
            className="scada-value"
          >
        ...
        <SensorBadge
          ...
          type="AT"
          id="AT-202"
          value={`${s.wtOilInWater.toFixed(0)} ppm`}
          onClick={sel("AT-202")}
        />
        <SensorBadge
          x={420}
          ...
          type="FT"
          id="FT-202"
          value={`${(s.lv202 * 0.6).toFixed(0)} m³/h`}
          onClick={sel("FT-202")}
        />
        ...
        <g onClick={sel("wtank")} className="cursor-pointer">
          <rect
            ...
            rx="4"
          />
          <clipPath id="wtankClip">
            <rect x="681" y="641" width="178" height="178" />
          </clipPath>
          <g clipPath="url(#wtankClip)">
            <rect
              x="680"
              y={820 - s.waterLevel * 1.4}
              width="180"
              height={s.waterLevel * 1.4 + 4}
              fill="url(#oWater)"
              opacity="0.85"
            />
          </g>
          ...
          <text
            ...
            className="scada-value"
          >
            {(s.waterLevel * 12).toFixed(0)} m³ · {s.sepTemp.toFixed(0)}°C
          </text>
        </g>
      </svg>
      ...
      <div className="absolute right-2 top-2 z-10 flex flex-col gap-1">
        <button
          onClick={() => setUserZoom((z) => Math.min(4, +(z + 0.2).toFixed(2)))}
          className="grid h-9 w-9 place-items-center rounded-md border border-border bg-card/90 hover:bg-muted backdrop-blur"
        >
          <ZoomIn className="h-4 w-4" />
        </button>
        <button
          onClick={() => setUserZoom((z) => Math.max(0.3, +(z - 0.2).toFixed(2)))}
          className="grid h-9 w-9 place-items-center rounded-md border border-border bg-card/90 hover:bg-muted backdrop-blur"
        >
      ...
      <div className="pointer-events-none absolute left-2 top-2 rounded-md border border-border bg-card/80 p-2 font-mono text-[10px] backdrop-blur">
        ...
        <div className="flex flex-wrap gap-2">
          <span>
            <span className="inline-block h-2 w-3 align-middle" style={{ background: OIL }} /> CRUDE
          </span>
          <span>
            <span className="inline-block h-2 w-3 align-middle" style={{ background: WATER }} />{" "}
            WATER
          </span>
          <span>
            <span className="inline-block h-2 w-3 align-middle" style={{ background: GAS }} /> GAS
          </span>
        </div>
      </div>
  ...
  return (
    <g>
      ...
      <path
        d={d}
        stroke={color}
        strokeWidth={Math.max(4, thick - 6)}
        fill="none"
        strokeLinecap="round"
        strokeLinejoin="round"
        strokeDasharray={dashed ? "12 8" : "10 6"}
        opacity="0.9"
      />
    </g>
  );
...
function SensorBadge({
  ...
  return (
    <g onClick={onClick} className={onClick ? "cursor-pointer" : ""}>
      ...
      <text x={x} y={y + 4} textAnchor="middle" fill="#0a0e1a" fontSize="11" fontWeight="700">
        {type}
      </text>
      <text
        x={x}
  ...
  return (
    <g onClick={onClick} className="cursor-pointer">
      ...
      <line
        ...
        strokeWidth="2.5"
      />
      <text x={x + r + 8} y={y + 4} fill="#9aa3b8" fontSize="13" className="scada-value">
        {label}
      </text>
      <text x={x + r + 8} y={y + 18} fill={c} fontSize="12" className="scada-value">
        {open >= 95 ? "OPEN" : open <= 5 ? "CLOSED" : `${open.toFixed(0)}%`}
      </text>
    </g>
  );
}
...
function ControlValve({
  ...
  return (
    <g onClick={onClick} className="cursor-pointer">
      ...
      />
      <polygon
        points={`${x - 6},${y - r - 30} ${x + 6},${y - r - 30} ${x},${y - r - 22}`}
        fill="#0080ff"
      />
      <text x={x + r + 8} y={y - 4} fill="#9aa3b8" fontSize="13" className="scada-value">
        {label}
      </text>
      <text x={x + r + 8} y={y + 12} fill={c} fontSize="12" className="scada-value">
        {tag || `${open.toFixed(0)}%`}
      </text>
    </g>
  );
...
function PSV({
  ...
  return (
    <g onClick={onClick} className={`cursor-pointer ${open ? "animate-alarm" : ""}`}>
      ...
      {/* spring (zig-zag) */}
      <polyline
        points={`${x - 8},${y - 14} ${x - 4},${y - 22} ${x + 4},${y - 18} ${x - 4},${y - 30} ${x + 4},${y - 34} ${x},${y - 42}`}
        fill="none"
        stroke="#0080ff"
        strokeWidth="2"
      />
      ...
      <text x={x - 36} y={y + 10} textAnchor="end" fill={c} fontSize="11" className="scada-value">
        SP {setP} bar
      </text>
      <text
        x={x - 36}
        y={y + 22}
        textAnchor="end"
        fill={open ? "#ff4444" : "#7d869c"}
        fontSize="11"
        className="scada-value"
      >
        {open ? "RELIEVING" : "CLOSED"}
      </text>
    </g>
  );
}
...
function DetailPanel({ id }: { id: string }) {
  ...
  > = {
    well: {
      title: "Wellhead WH-201",
      rows: [
        ["Pressure", `${s.wellPressure.toFixed(1)} bar`],
        ["Temp", `${s.wellTemp.toFixed(0)} °C`],
      ],
      design: "Max 200 bar / 120 °C",
      status: "FLOWING",
    },
    choke: {
      title: "Choke Valve CV-201",
      rows: [
        ["Opening", `${s.chokeOpen.toFixed(0)} %`],
        ["Upstream", `${s.upstreamP.toFixed(1)} bar`],
        ["Downstream", `${s.downstreamP.toFixed(1)} bar`],
      ],
      design: "ΔP up to 150 bar",
    },
    sep: {
      title: "3-Phase Separator V-201",
      rows: [
        ["Pressure", `${s.sepPressure.toFixed(1)} bar`],
        ["Temp", `${s.sepTemp.toFixed(1)} °C`],
        ["Oil level", `${s.oilLevel.toFixed(0)} %`],
        ["Water level", `${s.waterLevel.toFixed(0)} %`],
        ["BS&W", `${s.bsw.toFixed(2)} %`],
        ["Gas out", `${s.sepGasFlow.toFixed(0)} m³/h`],
      ],
      design: "MAWP 25 bar / 90 °C",
      status: "NORMAL",
    },
    pump: {
      title: "Crude Pump P-201",
      rows: [
        ["Status", s.pumpRunning ? "RUNNING" : "STOPPED"],
        ["Flow", `${s.pumpFlow.toFixed(1)} m³/h`],
        ["ΔP", `${s.pumpDP.toFixed(2)} bar`],
        ["Efficiency", `${s.pumpEff.toFixed(0)} %`],
        ["Speed", `${s.pumpRpm.toFixed(0)} rpm`],
      ],
      design: "BEP 180 m³/h @ 12 bar",
      status: s.pumpRunning ? "RUNNING" : "STOPPED",
    },
    hx: {
      title: "Heat Exchanger E-201",
      rows: [
        ["Crude in", `${s.hxCrudeIn.toFixed(1)} °C`],
        ["Crude out", `${s.hxCrudeOut.toFixed(1)} °C`],
        ["Duty", `${s.hxDuty.toFixed(0)} kW`],
        ["LMTD", `${s.hxLMTD.toFixed(2)} °C`],
        ["Fouling", `${(s.hxFouling * 100).toFixed(1)} %`],
        ["Utility flow", `${s.utilityFlow.toFixed(0)} %`],
      ],
      design: "U=800 W/m²K · A=50 m²",
    },
    dehy: {
      title: "Electrostatic Dehydrator D-201",
      rows: [
        ["Status", s.dehydratorOn ? "ENERGIZED" : "OFF"],
        ["Voltage", `${s.dehydratorKV.toFixed(1)} kV`],
        ["BS&W in", `${s.bswIn.toFixed(2)} %`],
        ["BS&W out", `${s.bswOut.toFixed(2)} %`],
      ],
      design: "15–30 kV electrostatic",
    },
    tank: {
      title: "Storage Tank TK-201",
      rows: [
        ["Level", `${s.tankLevel.toFixed(1)} %`],
        ["Volume", `${s.tankVolume.toFixed(0)} m³`],
        ["Temp", `${s.tankTemp.toFixed(1)} °C`],
        ["Vapor P", `${s.vaporP.toFixed(2)} barg`],
      ],
      design: "Capacity 10 000 m³ · floating roof",
    },
    wt: {
      title: "Water Treatment WT-201",
      rows: [
        ["Oil-in-water", `${s.wtOilInWater.toFixed(0)} ppm`],
        ["Discharge limit", "40 ppm"],
      ],
      design: "OSPAR ≤ 40 ppm",
    },
    wtank: {
      title: "Produced Water Tank",
      rows: [
        ["Level (eqv.)", `${s.waterLevel.toFixed(0)} %`],
        ["Volume", `${(s.waterLevel * 12).toFixed(0)} m³`],
      ],
    },
  };
  ...
  const valveMap: Record<string, () => { title: string; rows: [string, string][] }> = {
    "SDV-201": () =>
      valveRows("SDV-201", "Gate (Shutdown)", 100, [
        ["Upstream P", `${s.wellPressure.toFixed(1)} bar`],
        ["Function", "Emergency isolation"],
      ]),
    "CV-201": () =>
      valveRows("CV-201", "Control (Choke)", s.chokeOpen, [
        ["Upstream", `${s.upstreamP.toFixed(1)} bar`],
        ["Downstream", `${s.downstreamP.toFixed(1)} bar`],
      ]),
    "LV-201": () =>
      valveRows("LV-201", "Control (Oil Lvl)", s.lv201, [
        ["Loop", "LIC-201"],
        ["Flow", `${s.crudeFlow.toFixed(0)} m³/h`],
      ]),
    "LV-202": () =>
      valveRows("LV-202", "Control (Water Lvl)", s.lv202, [
        ["Loop", "LIC-202"],
        ["Flow", `${(s.lv202 * 0.6).toFixed(0)} m³/h`],
      ]),
    "PV-201": () =>
      valveRows("PV-201", "Control (Gas P)", 70, [
        ["Loop", "PIC-201"],
        ["Gas flow", `${s.sepGasFlow.toFixed(0)} m³/h`],
      ]),
    "XV-201": () =>
      valveRows("XV-201", "Gate (Pump Suction)", s.pumpRunning ? 100 : 100, [
        ["Interlock", "Must be OPEN before pump start"],
      ]),
    "FV-201": () =>
      valveRows("FV-201", "Control (Flow)", s.fv201, [
        ["Loop", "FIC-201"],
        ["Flow", `${s.pumpFlow.toFixed(0)} m³/h`],
      ]),
    "CV-202": () => valveRows("CV-202", "Check Valve", 100, [["Function", "Prevent reverse flow"]]),
    "TV-201": () =>
      valveRows("TV-201", "Control (Temp)", s.utilityFlow, [
        ["Loop", "TIC-201"],
        ["Crude out", `${s.hxCrudeOut.toFixed(0)} °C`],
      ]),
    "XV-202": () =>
      valveRows("XV-202", "Gate (Export)", s.exportValve, [["Function", "Final export isolation"]]),
    "PSV-201": () =>
      valveRows("PSV-201", "Safety Relief", s.sepPressure > 15 ? 100 : 0, [
        ["Set pressure", "15 bar"],
        ["Actual", `${s.sepPressure.toFixed(1)} bar`],
        ["State", s.sepPressure > 15 ? "RELIEVING" : "CLOSED"],
      ]),
    "PSV-202": () =>
      valveRows("PSV-202", "Safety Relief", s.vaporP > 5 ? 100 : 0, [
        ["Set pressure", "5 bar"],
        ["Actual", `${s.vaporP.toFixed(2)} bar`],
        ["State", s.vaporP > 5 ? "RELIEVING" : "CLOSED"],
      ]),
  };

  const sensorMap: Record<string, () => { title: string; rows: [string, string][] }> = {
    "PT-201": () =>
      sensorRows("PT-201", "Pressure", `${s.wellPressure.toFixed(0)} bar`, "80 bar", "180 bar"),
    "TT-201": () =>
      sensorRows("TT-201", "Temperature", `${s.wellTemp.toFixed(0)} °C`, "30 °C", "120 °C"),
    "PT-202": () =>
      sensorRows("PT-202", "Pressure", `${s.sepPressure.toFixed(1)} bar`, "5 bar", "14 bar"),
    "TT-202": () =>
      sensorRows("TT-202", "Temperature", `${s.sepTemp.toFixed(0)} °C`, "40 °C", "95 °C"),
    ...
    "FT-201": () =>
      sensorRows("FT-201", "Flow", `${s.pumpFlow.toFixed(0)} m³/h`, "50 m³/h", "220 m³/h"),
    "PT-203": () =>
      sensorRows(
        "PT-203",
        "Pressure",
        `${(s.sepPressure * 0.9).toFixed(1)} bar`,
        "1 bar",
        "20 bar",
      ),
    "TT-203": () =>
      sensorRows("TT-203", "Temperature", `${s.hxCrudeOut.toFixed(0)} °C`, "70 °C", "120 °C"),
    "TT-204": () =>
      sensorRows("TT-204", "Temperature", `${s.tankTemp.toFixed(0)} °C`, "20 °C", "95 °C"),
    "LT-203": () => sensorRows("LT-203", "Level", `${s.tankLevel.toFixed(0)} %`, "10 %", "90 %"),
    "FT-202": () =>
      sensorRows("FT-202", "Flow", `${(s.lv202 * 0.6).toFixed(0)} m³/h`, "0 m³/h", "80 m³/h"),
    "AT-202": () =>
      sensorRows("AT-202", "Oil-in-Water", `${s.wtOilInWater.toFixed(0)} ppm`, "—", "40 ppm"),
  };
  ...
  return (
    <div
      className="absolute bottom-3 left-3 right-3 z-10 rounded-md border border-border bg-card/95 p-3 backdrop-blur sm:right-auto sm:max-w-xs"
    ...
    >
      ...
      <div className="space-y-1">
        {panel.rows.map(([k, v]) => (
          <div
            key={k}
            className="flex justify-between border-b border-border/40 py-1 font-mono text-xs"
          >
            <span className="text-muted-foreground">{k}</span>
            <span className="scada-value">{v}</span>
          </div>
        ))}
        {panel.design && (
        ...
        {panel.status && (
          <div className="font-mono text-[10px] text-[#00ff88]">Status: {panel.status}</div>
        )}
      </div>
    </div>
  );
