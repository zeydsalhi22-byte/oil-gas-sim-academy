...
const dict: Dict = {
  ...
  live_engine: { en: "Live process simulation engine running", ar: "محرّك محاكاة العملية يعمل مباشرة" },
  ...
  gas_desc: { en: "Wellhead, separator, compressor, treatment, SCADA control room and 4 simulators.", ar: "رأس البئر، الفاصل، الضاغط، المعالجة، غرفة تحكم SCADA و4 محاكيات." },
  oil_desc: { en: "Three-phase separation, crude processing, pumps and pipelines.", ar: "فصل ثلاثي الأطوار، معالجة الخام، المضخات والأنابيب." },
  storage_desc: { en: "Tank farm, inventory control, tank gauging and loading systems.", ar: "حقل خزانات، التحكم بالمخزون، قياس الخزانات وأنظمة التحميل." },
  active: { en: "ACTIVE", ar: "نشط" },
  coming_soon: { en: "COMING SOON", ar: "قريبًا" },
  footer: { en: "OILSIM ACADEMY · TRAINING SIMULATOR · v1.0", ar: "أويل سيم أكاديمية · محاكي تدريب · v1.0" },
  ...
  fault_intro: { en: "Observe the SCADA trends and Plant view to identify the failed device.", ar: "راقب منحنيات SCADA وعرض المصنع لتحديد الجهاز المعطّل." },
  fault_active: { en: "Fault is active. Look for the symptoms below, then submit your diagnosis.", ar: "العطل فعّال. راقب الأعراض أدناه ثم قدّم تشخيصك." },
