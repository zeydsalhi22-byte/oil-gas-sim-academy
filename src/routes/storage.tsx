  ...
  head: () => ({
    meta: [
      { title: "Storage Sector — OilSim Academy" },
      {
        name: "description",
        content:
          "Gas & oil storage terminal simulator — floating-roof tanks, gas spheres, transfer pumps, fiscal metering and SCADA training.",
      },
      { property: "og:title", content: "Storage Sector — OilSim Academy" },
      {
        property: "og:description",
        content:
          "Interactive tank farm simulator with PID level control, startup sequence, fault diagnosis and inventory management.",
      },
    ],
  }),
        ...
        <div className="grid grid-cols-[auto_minmax(0,1fr)_auto_auto] items-center gap-2 px-3 py-2 sm:px-5">
          ...
          <div className="min-w-0">
            <div className="font-mono text-[10px] uppercase tracking-widest text-muted-foreground">
              {lang === "ar" ? "قطاع التخزين · STG-01" : "Storage Sector · STG-01"}
            </div>
